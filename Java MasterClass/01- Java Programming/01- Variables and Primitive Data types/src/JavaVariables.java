public class JavaVariables {
    ...
    public static void main(String[] args) {
        ...
        /* Variables are named storage location that hold a value */
        int variableOne;        //Variable declaration
        variableOne = 10;       //Variable init
        ...
        System.out.println("//   used for one line comment");
        System.out.println("/**/ used for multiple lines comment");
    }
